...
<Callout >
  `ApiRequest` uses the `getRequest`, `postRequest` and `putRequest` functions from the `@starberry/gatsby-theme-utils` package. For more information about these functions, see the [getRequest](/gatsby-theme-utils/ApiRequest/get), [postRequest](/gatsby-theme-utils/ApiRequest/post) and [putRequest](/gatsby-theme-utils/ApiRequest/put) pages.
</Callout
